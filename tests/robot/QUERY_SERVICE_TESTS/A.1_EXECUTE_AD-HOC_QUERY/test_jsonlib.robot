...
*** Variables ***
${ACTUAL JSON PAYLOAD}   ${PROJECT_ROOT}/tests/robot/_resources/fixtures/json_payloads/actual
${EXPECTED JSON PAYLOAD}    ${PROJECT_ROOT}/tests/robot/_resources/fixtures/json_payloads/expected
