*** Settings ***
Documentation     Alternative Flow 1: Get Composition Latest, Composition Does Not Exist (XML)
...
*** Test Cases ***
Alternative Flow 1: Get Composition Latest, Composition Does Not Exist (XML)
    Create EHR    XML
