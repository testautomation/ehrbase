*** Settings ***
Documentation     Alternative Flow 2: Create Persistent Composition For The Same Archetype Twice (XML)
...
*** Test Cases ***
Alternative Flow 2: Create Persistent Composition For The Same Archetype Twice (XML)
    Upload OPT    ${OPT_FILE}    XML
    Create EHR    XML
    Commit Composition (XML)    ${XML_FILE}
    Commit Same Composition Again    ${XML_FILE}
