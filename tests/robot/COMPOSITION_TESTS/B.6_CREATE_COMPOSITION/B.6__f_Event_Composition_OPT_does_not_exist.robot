*** Settings ***
Documentation     Alternative Flow 5: Create New Event Composition Referenced Opt Does Not Exist
...
*** Test Cases ***
Alternative Flow 5: Create New Event Composition Referenced Opt Does Not Exist
    Create EHR
